...
const SectionService = () => {
  return (
    <div className={'section-service custom-container_small'}>
      <div className={'section-service__left-content'}>
        <p className={'title section-service__title'}>Our Services</p>
        <p className={'section-service__sub-title sub-title'}>Our staff extension services include</p>
        <SectionServiceSpoiler/>
      </div>
      <div className={'section-service__right-content'}>
        <p className={'title'}>Security</p>
        <p className={'section-service__sub-title sub-title'}>POLI Compliance</p>
